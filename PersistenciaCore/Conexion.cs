...
namespace PersistenciaCore
{
    public class Conexion
    {
       ...
       // private static string connectionString = "Data Source=BLACKBIRD2\\SQLEXPRESS;Integrated Security=false;database=EnviosContext;User ID=EnviosDBManager;Password=EnviosService;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        private static string connectionString = "Data Server=DESKTOP-UNPUO8M\\MATIAS\\SQLEXPRESS;Integrated Security=false;database=EnviosContext;User ID=EnviosDBManager;Password=EnviosService;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
